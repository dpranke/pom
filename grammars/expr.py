...
class Parser(object):
    ...
    def _r_grammar(self):
        self._h_scope('grammar', [lambda: self._h_re('( |\n)*'),
                                  lambda: self._h_bind(self._r_expr, '_2'),
                                  lambda: self._h_re('( |\n)*'),
                                  self._r_end,
    ...
    def _s_expr_l_c0(self):
        self._h_scope('expr', [lambda: self._h_bind(self._r_expr, '_1'),
                               ...
                               lambda: self._h_ch('+'),
                               self._r_sp,
                               lambda: self._h_bind(lambda: self._h_capture(self._r_num), '_5'),
                               lambda: self._h_succeed([self._h_get('_1'), '+', self._h_get('_5')])])
